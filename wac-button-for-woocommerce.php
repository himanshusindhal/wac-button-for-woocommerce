<?php
/**
 * Plugin Name: WAC Button for WooCommerce
 * Plugin URI:  https://github.com/himanshusindhal/wac-button-for-woocommerce
 ...
 * Text Domain: wac-button-for-woocommerce
 *
...
function swob_woocommerce_missing_notice() {
	...
	<div class="notice notice-error is-dismissible">
		<p><?php esc_html_e( 'WAC Button for WooCommerce requires WooCommerce to be installed and active.', 'wac-button-for-woocommerce' ); ?></p>
	</div>
	<?php
}
