<?php
/**
 * Plugin Name: Click2Chat Order for WooCommerce
 * Plugin URI:  https://github.com/himanshusindhal/click2chat-order-for-woocommerce
 ...
 * Text Domain: click2chat-order-for-woocommerce
 *
...
function swob_woocommerce_missing_notice() {
	...
	<div class="notice notice-error is-dismissible">
		<p><?php esc_html_e( 'Click2Chat Order for WooCommerce requires WooCommerce to be installed and active.', 'click2chat-order-for-woocommerce' ); ?></p>
	</div>
	<?php
}
