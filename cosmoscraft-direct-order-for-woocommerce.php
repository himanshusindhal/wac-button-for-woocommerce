<?php
/**
 * Plugin Name: CosmosCraft Direct Order for WooCommerce
 * Plugin URI:  https://github.com/himanshusindhal/cosmoscraft-direct-order-for-woocommerce
 ...
 * Text Domain: cosmoscraft-direct-order-for-woocommerce
 *
...
function swob_woocommerce_missing_notice() {
	...
	<div class="notice notice-error is-dismissible">
		<p><?php esc_html_e( 'CosmosCraft Direct Order for WooCommerce requires WooCommerce to be installed and active.', 'cosmoscraft-direct-order-for-woocommerce' ); ?></p>
	</div>
	<?php
}
